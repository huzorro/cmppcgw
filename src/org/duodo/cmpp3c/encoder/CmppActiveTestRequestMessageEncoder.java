 ...
 *
 */
public class CmppActiveTestRequestMessageEncoder extends OneToOneEncoder {
	private PacketType packetType;
	
	public CmppActiveTestRequestMessageEncoder() {
		this(CmppPacketType.CMPPACTIVETESTREQUEST);
	}

	public CmppActiveTestRequestMessageEncoder(PacketType packetType) {
