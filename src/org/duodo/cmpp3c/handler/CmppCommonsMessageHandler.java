 ...
 *
 */
public class CmppCommonsMessageHandler extends SimpleChannelHandler {
	private final Logger logger = LoggerFactory.getLogger(CmppCommonsMessageHandler.class); 
	public CmppCommonsMessageHandler() {
	}
