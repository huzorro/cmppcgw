 ...
 *
 */
public class CmppDuplexstreamClientChannelPipelineFactory implements
	 ...
	 * 
	 */
	public CmppDuplexstreamClientChannelPipelineFactory(SessionConfig config) {
		this(config, new HashedWheelTimer());
	}
	
	public CmppDuplexstreamClientChannelPipelineFactory(SessionConfig config, Timer timer) {
		this.config = config;
		this.timer = timer;
	}	
